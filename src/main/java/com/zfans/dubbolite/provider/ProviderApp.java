...
public class ProviderApp {
    public static void main(String[] args) {
        ...
        // 本地注册
        LocalRegister.regist(HelloService.class.getName()
                        + HelloService1Impl.VERSION,
                HelloService1Impl.class);
        LocalRegister.regist(HelloService.class.getName()
                        + HelloService2Impl.VERSION,
                HelloService2Impl.class);

        // 注册中心注册 Redis Zookeeper ...
        ...
        System.out.println("启动对 " + url.getHostname() + ":" + url.getPort() + " 的监听。");
        protocol.start(url);
